...
const fun Operacoes::functions[] = {&Operacoes::nop, &Operacoes::aconst_null, &Operacoes::iconst_m1,\
	&Operacoes::iconst_0, &Operacoes::iconst_1, &Operacoes::iconst_2, &Operacoes::iconst_3, &Operacoes::iconst_4,\
	&Operacoes::iconst_5, &Operacoes::lconst_0, &Operacoes::lconst_1, &Operacoes::fconst_0, &Operacoes::fconst_1,\
	&Operacoes::fconst_2, &Operacoes::dconst_0, &Operacoes::dconst_1, &Operacoes::bipush, &Operacoes::sipush,\
	&Operacoes::ldc, &Operacoes::ldc_w, &Operacoes::ldc2_w, &Operacoes::iload, &Operacoes::lload, &Operacoes::fload,\
	&Operacoes::dload, &Operacoes::aload, &Operacoes::iload_0, &Operacoes::iload_1, &Operacoes::iload_2,\
	&Operacoes::iload_3, &Operacoes::lload_0, &Operacoes::lload_1, &Operacoes::lload_2, &Operacoes::lload_3,\
	&Operacoes::fload_0, &Operacoes::fload_1, &Operacoes::fload_2, &Operacoes::fload_3, &Operacoes::dload_0,\
	&Operacoes::dload_1, &Operacoes::dload_2, &Operacoes::dload_3, &Operacoes::aload_0, &Operacoes::aload_1,\
	&Operacoes::aload_2, &Operacoes::aload_3, &Operacoes::iaload, &Operacoes::laload, &Operacoes::faload,\
	&Operacoes::daload, &Operacoes::aaload, &Operacoes::baload, &Operacoes::caload, &Operacoes::saload,\
	&Operacoes::istore, &Operacoes::lstore, &Operacoes::fstore, &Operacoes::dstore, &Operacoes::astore,\
	&Operacoes::istore_0, &Operacoes::istore_1, &Operacoes::istore_2, &Operacoes::istore_3, &Operacoes::lstore_0,\
	&Operacoes::lstore_1, &Operacoes::lstore_2, &Operacoes::lstore_3, &Operacoes::fstore_0, &Operacoes::fstore_1,\
	&Operacoes::fstore_2, &Operacoes::fstore_3, &Operacoes::dstore_0, &Operacoes::dstore_1, &Operacoes::dstore_2,\
	&Operacoes::dstore_3, &Operacoes::astore_0, &Operacoes::astore_1, &Operacoes::astore_2, &Operacoes::astore_3,\
	&Operacoes::iastore, &Operacoes::lastore, &Operacoes::fastore, &Operacoes::dastore, &Operacoes::aastore,\
	&Operacoes::bastore, &Operacoes::castore, &Operacoes::sastore, &Operacoes::pop, &Operacoes::pop2, &Operacoes::dup,\
	&Operacoes::dup_x1, &Operacoes::dup_x2, &Operacoes::dup2, &Operacoes::dup2_x1, &Operacoes::dup2_x2, &Operacoes::swap, &Operacoes::iadd,\
	&Operacoes::ladd, &Operacoes::fadd, &Operacoes::dadd, &Operacoes::isub, &Operacoes::lsub, &Operacoes::fsub,\
	&Operacoes::dsub, &Operacoes::imul, &Operacoes::lmul, &Operacoes::fmul, &Operacoes::dmul, &Operacoes::idiv,\
	&Operacoes::ldiv, &Operacoes::fdiv, &Operacoes::ddiv, &Operacoes::irem, &Operacoes::lrem, &Operacoes::frem,\
	&Operacoes::drem, &Operacoes::ineg, &Operacoes::lneg, &Operacoes::fneg, &Operacoes::dneg, &Operacoes::ishl,\
	&Operacoes::lshl, &Operacoes::ishr, &Operacoes::lshr, &Operacoes::iushr, &Operacoes::lushr, &Operacoes::iand,\
	&Operacoes::land, &Operacoes::ior, &Operacoes::lor, &Operacoes::ixor, &Operacoes::lxor, &Operacoes::iinc,\
	&Operacoes::i2l, &Operacoes::i2f, &Operacoes::i2d, &Operacoes::l2i, &Operacoes::l2f, &Operacoes::l2d, &Operacoes::f2i,\
	&Operacoes::f2l, &Operacoes::f2d, &Operacoes::d2i, &Operacoes::d2l, &Operacoes::d2f, &Operacoes::i2b, &Operacoes::i2c,\
	&Operacoes::i2s, &Operacoes::lcmp, &Operacoes::fcmpl, &Operacoes::fcmpg, &Operacoes::dcmpl, &Operacoes::dcmpg,\
	&Operacoes::ifeq, &Operacoes::ifne, &Operacoes::iflt, &Operacoes::ifge, &Operacoes::ifgt, &Operacoes::ifle,\
	&Operacoes::if_icmpeq, &Operacoes::if_icmpne, &Operacoes::if_icmplt, &Operacoes::if_icmpge, &Operacoes::if_icmpgt,\
	&Operacoes::if_icmple, &Operacoes::if_acmpeq, &Operacoes::if_acmpne, &Operacoes::funcgoto, &Operacoes::jsr,\
	&Operacoes::funcret, &Operacoes::tableswitch, &Operacoes::lookupswitch, &Operacoes::ireturn, &Operacoes::lreturn,\
	&Operacoes::freturn, &Operacoes::dreturn, &Operacoes::areturn, &Operacoes::func_return, &Operacoes::getstatic,\
	&Operacoes::putstatic, &Operacoes::getfield, &Operacoes::putfield, &Operacoes::invokevirtual, &Operacoes::invokespecial,\
	&Operacoes::invokestatic, &Operacoes::invokeinterface, &Operacoes::nop, &Operacoes::func_new, &Operacoes::newarray,\
	&Operacoes::anewarray, &Operacoes::arraylength, &Operacoes::athrow, &Operacoes::nop, &Operacoes::nop, &Operacoes::nop,\
	&Operacoes::nop, &Operacoes::wide, &Operacoes::multianewarray, &Operacoes::ifnull, &Operacoes::ifnonnull,\
	&Operacoes::goto_w, &Operacoes::jsr_w};
