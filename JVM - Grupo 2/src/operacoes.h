...
private:
	...
	/*! \fn uint32_t getNBytesValue(uint8_t n, unsigned char** code)
		...
		\param n Define quantas posições serão deslocadas e quantos bytes serão lidos.
		\param pc Ponteiro para o PC.
	*/
	...
	/*! \fn ClasseEstatica* getStaticClassThatHasField(ClasseEstatica* base, string field_name)
		\brief Recursivamente procura por uma ClasseEstatica que contenha um determinado campo.

		\param base ClasseEstatica que serve como base para a procura do campo, caso o campo nao seja encontrado nessa classe, va para a SuperClasse.
		\param field_name Nome do campo que se deseja procurar.
	*/
